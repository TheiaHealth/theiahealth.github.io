...
jQuery(function ($) {
   ...
   var $this = $(this);
      ...
      $("#step1").click(function() {
          if($("#detail1").is(":hidden")){
             $(".process-detail:visible").fadeOut(100);
             $(".pro-step").removeClass("pro-step-clicked");
             $("#detail1").delay(100).fadeIn(300);
             $("#step1").addClass("pro-step-clicked");
          } else if($("#detail1").is(":visible")){
             $("#detail1").fadeOut(100);
             $("#step1").removeClass("pro-step-clicked");
          }
      });

      $("#step2").click(function() {
          if($("#detail2").is(":hidden")){
             $(".process-detail:visible").fadeOut(300);
             $(".pro-step").removeClass("pro-step-clicked");
             $("#detail2").delay(100).fadeIn(300);
             $("#step2").addClass("pro-step-clicked");
          } else if($("#detail2").is(":visible")){
             $("#detail2").fadeOut(100);
             $("#step2").removeClass("pro-step-clicked");
          }
      });
      ...
      $("#step3").click(function() {
          if($("#detail3").is(":hidden")){
             $(".process-detail:visible").fadeOut(300);
             $(".pro-step").removeClass("pro-step-clicked");
             $("#detail3").delay(100).fadeIn(300);
             $("#step3").addClass("pro-step-clicked");
          } else if($("#detail3").is(":visible")){
             $("#detail3").fadeOut(100);
             $("#step3").removeClass("pro-step-clicked");
          }
      });
      ...
      $("#step4").click(function() {
          if($("#detail4").is(":hidden")){
             $(".process-detail:visible").fadeOut(300);
             $(".pro-step").removeClass("pro-step-clicked");
             $("#detail4").delay(100).fadeIn(300);
             $("#step4").addClass("pro-step-clicked");
          } else if($("#detail4").is(":visible")){
             $("#detail4").fadeOut(100);
             $("#step4").removeClass("pro-step-clicked");
          }
      });
      ...
      $("#step5").click(function() {
          if($("#detail5").is(":hidden")){
             $(".process-detail:visible").fadeOut(300);
             $(".pro-step").removeClass("pro-step-clicked");
             $("#detail5").delay(100).fadeIn(300);
             $("#step5").addClass("pro-step-clicked");
          } else if($("#detail5").is(":visible")){
             $("#detail5").fadeOut(100);
             $("#step5").removeClass("pro-step-clicked");
          }
      });
